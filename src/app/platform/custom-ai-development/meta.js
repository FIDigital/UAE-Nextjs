export const metadata = {
    ...
    keywords: 'custom AI development Dubai, LangChain UAE, AI agent development, Python AI Dubai, autonomous AI agents, RAG development Dubai',
    openGraph: {
        title: 'Custom AI Agent Development Dubai | LangChain & Python | FI Digital',
        description: 'We build custom AI agents with LangChain and Python that remember context and take autonomous action.',
    ...
    alternates: {
        canonical: 'https://www.fidigital.ae/platform/custom-ai-development',
    }
};
