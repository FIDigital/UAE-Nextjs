export const metadata = {
    ...
    keywords: 'data analytics Dubai, business intelligence UAE, BI dashboard Dubai, data visualization UAE, reporting automation',
    openGraph: {
        title: 'Data Analytics & BI Dubai | Zoho Analytics + AI | FI Digital',
        description: 'Transform business data into actionable insights with Zoho Analytics, custom dashboards, and AI-powered reporting.',
    ...
    alternates: {
        canonical: 'https://www.fidigital.ae/platform/data-analytics',
    }
};
