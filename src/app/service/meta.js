export const metadata = {
    ...
    description: 'Transform your customer service into a competitive advantage. AI-powered ticketing, WhatsApp support agents, and self-service portals for UAE enterprises.',
    keywords: 'Zoho Desk UAE, customer service automation, support AI agents, service desk implementation',
    openGraph: {
        title: 'Zoho Service & Support Automation UAE | FI Digital',
